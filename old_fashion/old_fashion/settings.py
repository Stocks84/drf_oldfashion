"""
Django settings for old_fashion project.
...
SECRET_KEY = 'django-insecure-^-9+==cf!66r#=rp7e(#-2xn%a=v-*tk%((d@yn$t3jv-pm@64'
...
WSGI_APPLICATION = 'old_fashion.wsgi.application'
